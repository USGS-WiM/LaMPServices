...
namespace LaMPServices.Handlers
{
    public abstract class HandlerBase
    {
        ...
        private String connectionString = ConfigurationManager.ConnectionStrings["LaMPDSEntities"].ConnectionString;
        ...
        protected LaMPDSEntities GetRDS()
        {
            return new LaMPDSEntities(string.Format(connectionString, "LAMPPUBLIC", "L6mP_Pub1ic"));
        }
        ...
        /// <summary>
        /// capitializes all words in phrase
        /// </summary>
