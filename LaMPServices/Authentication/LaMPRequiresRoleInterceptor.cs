...
{
    public class LaMPRequiresRoleInterceptor: OperationInterceptor
    {
        
        #region Constructors

        public LaMPRequiresRoleInterceptor(ICommunicationContext context)
        {
            _context = context;
        }
