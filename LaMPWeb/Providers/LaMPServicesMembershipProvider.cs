//------------------------------------------------------------------------------
//----- LaMPServicesMembershipProvider.cs ----------------------------------------------------
//------------------------------------------------------------------------------
...
//  another better example: http://theintegrity.co.uk/2010/11/asp-net-mvc-2-custom-membership-provider-tutorial-part-2/  -- using LaMPServiceCaller like
//  validateUser does.
//     
...
namespace LaMPWeb.Providers
{
    public class LaMPServicesMembershipProvider : MembershipProvider
    {
        ...
        public override MembershipUser CreateUser(string username, string password, string email, string passwordQuestion, string passwordAnswer, bool isApproved, object providerUserKey, out MembershipCreateStatus status)
        {
            ...
            if (membershipUser == null)
            {
                try
                {
                    ...
                    //{
                    DATA_MANAGER user = new DATA_MANAGER();
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            ...
            try
            {
                ...
                request.RootElement = "DataManager";
                request.AddParameter("userName", username, ParameterType.UrlSegment);
                DATA_MANAGER thisMember = serviceCaller.Execute<DATA_MANAGER>(request);

                if (thisMember != null)
                {
                    memUser = new MembershipUser("LaMPServicesMembershipProvider",
